...
(function(){
  ...
  const T = {
    ...
    "Próximo · Agir":"Next · Agir","Próximo · Sunem":"Next · Sunem","Próximo · Casa Li":"Next · Casa Li","Próximo · Àurea":"Next · Àurea",
    // ---- Àurea
    "Arquitetura atemporal":"Timeless architecture",
    "Posicionamento":"Positioning","Identidade Verbal":"Verbal Identity","Sistema Visual":"Visual System",
    "Equilíbrio, sofisticação silenciosa e permanência traduzidos em uma identidade contemporânea e atemporal.":"Balance, quiet sophistication and permanence translated into a contemporary, timeless identity.",
    "Espaços que atravessam o tempo com relevância.":"Spaces that remain relevant through time.",
    "Posicionamento · Identidade Verbal · Sistema Visual":"Positioning · Verbal Identity · Visual System",
    "A Àurea é um escritório de arquitetura que acredita que os espaços devem atravessar o tempo com relevância. Mais do que responder a necessidades funcionais, seus projetos nascem da relação entre contexto, matéria, luz e experiência humana.":"Àurea is an architecture studio that believes spaces should remain relevant through time. More than responding to functional needs, its projects emerge from the relationship between context, materiality, light and human experience.",
    "Cada ambiente é concebido como uma extensão da vida de quem o habita, equilibrando precisão técnica e sensibilidade estética em soluções que permanecem significativas ao longo dos anos. Fundada com a convicção de que a arquitetura deve ir além das tendências, a Àurea encontra na simplicidade, na proporção e na permanência os princípios que orientam sua atuação.":"Every environment is conceived as an extension of the lives of those who inhabit it, balancing technical precision and aesthetic sensitivity to create spaces that remain meaningful for years to come. Founded on the belief that architecture should transcend trends, Àurea finds in simplicity, proportion and permanence the principles that guide its practice.",
    "Este projeto de identidade foi desenvolvido para traduzir visualmente essa visão. O trabalho envolveu a definição do posicionamento estratégico da marca, a construção de sua identidade verbal e o desenvolvimento de um sistema visual capaz de expressar equilíbrio, sofisticação silenciosa e permanência através de uma linguagem contemporânea e atemporal.":"This identity project was developed to visually translate that vision. The work involved defining the brand's strategic positioning, crafting its verbal identity, and developing a visual system capable of expressing balance, quiet sophistication and permanence through a contemporary and timeless language."
  };
